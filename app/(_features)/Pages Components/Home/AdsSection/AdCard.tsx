...
export const AdCard = ({ title, price, imageUrl }: AdCardProps) => {
    const fullImageUrl = imageUrl.startsWith('http')
        ? imageUrl
        : `https://souqshamel.com/storage/app/public/${imageUrl}`;

    return (
        <div className="bg-white rounded-[15px] md:rounded-[25px] overflow-hidden shadow-sm border border-gray-100 h-full flex flex-col p-2 md:p-4 transition-all duration-300 hover:shadow-md group">
